...
public class GameUIView : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        EventService.Instance.OnKeysPickedUp.AddListener(UpdateKeyText);
    }

    private void OnDisable() => EventService.Instance.OnKeysPickedUp.RemoveListener(UpdateKeyText); 
